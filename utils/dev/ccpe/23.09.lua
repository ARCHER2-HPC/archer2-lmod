help([[
Containerized CPE 23.09
=======================
This module allows you to build/run a third-party code using a containerized HPE Cray Programming Environment.

Instructions for using the containerized CPE module can be found at "/work/z19/z19/shared/ccpe/23.09/ccpe-docs".
...
scp -r <username>@login.archer2.ac.uk:/work/z19/z19/shared/ccpe/23.09/ccpe-docs ./
cd ccpe-docs
...
local ccpeLibPaths =  "/opt/cray/libfabric/1.12.1.2.2.1/lib64" .. ":/opt/cray/pe/pmi/default/lib" .. 
