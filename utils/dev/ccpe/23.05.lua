help([[
Containerized CPE 23.05
=======================
This module allows you to build/run a third-party code using a containerized HPE Cray Programming Environment.

Instructions for using the containerized CPE module can be found at "/work/z19/z19/shared/ccpe/23.05/ccpe-docs".
...
scp -r <username>@login.archer2.ac.uk:/work/z19/z19/shared/ccpe/23.05/ccpe-docs ./
cd ccpe-docs
