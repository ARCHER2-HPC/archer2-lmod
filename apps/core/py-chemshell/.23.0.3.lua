...
using the usual commands.
   ...
   Installation date: 9 September 2024
]])

LmodMessage([[

Loading Py-ChemShell 23.0.3 compiled with NWChem 7.2.2 and GULP 6.2.
...
local pkgVersionBase = pathJoin("/work/y07/shared/apps/core/py-chemshell/23.0.3")
