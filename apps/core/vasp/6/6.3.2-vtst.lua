...
This module sets up your environment to access VASP 6.3.2 with
the VASP Transition State Tools from the University of Texas included.
...
The VTST scripts are available in the $VTSTSCRIPTS directory.
...
prepend_path("PATH", pathJoin(pkgVersionBase, "vtstscripts-1029"))
setenv("VASP", pkgVersionBase)

setenv("VASP_VDW_KERNEL", pathJoin(pkgVersionBase, "vdw_kernel"))
setenv("VTSTSCRIPTS", pathJoin(pkgVersionBase, "vtstscripts-1029"))
