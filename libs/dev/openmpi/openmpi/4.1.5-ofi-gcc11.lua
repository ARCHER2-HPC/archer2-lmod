...
The OpenMPI 4.1.5 libraries were been built using GCC 11.2.0 (CPE 22.12) and OFI (libfabric/1.12.1.2.2.0.0). 
Build instructions: https://github.com/hpc-uk/build-instructions/blob/main/libs/openmpi/build_openmpi_4.1.5_archer2_gcc11.md
