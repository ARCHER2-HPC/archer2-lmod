...
Please note, this module should not be loaded at the same time as cray-mpich-ucx or any module linked to cray-mpich-ucx such as cray-libsci,
cray-hdf5-parallel, cray-netcdf-hdf5parallel, etc.

The OpenMPI 4.1.4 libraries were been built using GCC 11.2.0 (CPE 21.09) and UCX (cray-ucx/2.7.0-1). 
