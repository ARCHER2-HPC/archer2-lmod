help([[
NETCDF Fortran 4.6.0-ompi4-ucx-gcc11
====================================
NETCDF is a parallel IO library, see https://www.unidata.ucar.edu/software/netcdf/ .

This module was built with OpenMPI 4.1.4 using UCX (cray-ucx/2.7.0-1) and GCC 11.2.0 (CPE 21.09).
...
setenv("NETCDF_FORTRAN_DIR", pkgVersionBase)
