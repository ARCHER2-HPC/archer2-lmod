help([[
XIOS 2.5.r2254-mpich4-ofi-gcc11
===============================
...
libXML 2.9.7, MPICH 4.0.2 using OFI (libfabric/1.11.0.4.71) and GCC 11.2.0 (CPE 21.09).
...
load("mpich/4.0.2-ofi-gcc11")
load("hdf5/1.12.0-mpich4-ofi-gcc11")
load("netcdf/fortran/4.6.0-mpich4-ofi-gcc11")
load("netcdf/c/4.9.0-mpich4-ofi-gcc11")
load("libxml2/2.9.7")
